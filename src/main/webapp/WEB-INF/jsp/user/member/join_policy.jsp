				...
				<div class="policy_box policy_box1">
					<div class="policy_box_tit">
						...
						<div>
							...
							<ul class="policy_ul">
								<li>본 약관은 아일락브로우(이하 '회사'라 한다.)이 제공하는 인터넷 서비스 (영문영 eyelac.shop 이하 '서비스'라 한다.)를 이용함에 있어 이용조건 및 절차에 관한 기본적인 사항과 기타 필요한 사항에 관한 통합 약관의 정의를 목적으로 합니다. </li>
							</ul>
						</div>
				...
				<div class="policy_box policy_box2">
					<div class="policy_box_tit">
						...
						<div>
							...
							<ul class="policy_ul">
								<li>본 정책은 아일락뷰티살롱(이하 '회사'라 한다.)이 제공하는 인터넷 서비스 (영문영 eyelac.shop 이하 '서비스'라 한다.)를 이용함에 있어 개인정보보호 정책 정의를 목적으로 합니다.</li>
							</ul>
						</div>
